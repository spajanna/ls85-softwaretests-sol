...
if __name__ == "__main__":
    ...
    print(f"  Ergebnis: {berechne_gesamtpreis(warenkorb_normal)} (erwartet: 69.97)")

    # TODO: Test 2 – Einkauf mit 10 % Rabatt
    # Erwartetes Ergebnis: 62.97
    print("\nTest 2 – 10 % Rabatt:")
    print(f"  Ergebnis: {berechne_gesamtpreis(warenkorb_normal, 10)} (erwartet: 62.97)")

    # TODO: Test 3 – Leerer Warenkorb (Sonderfall)
    # Erwartetes Ergebnis: 0.0 (keine Exception!)
    print("\nTest 3 – Leerer Warenkorb:")
    print(f"  Ergebnis: {berechne_gesamtpreis(warenkorb_leer)} (erwartet: 0.0)")
